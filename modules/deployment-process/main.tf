...
resource "octopusdeploy_process_step" "set_image_step" {
  ...
  execution_properties = merge(
    ...
    (lookup(each.value, "main_step_namespace", null) != null ?
      { "Octopus.Action.KubernetesContainers.Namespace" = each.value.main_step_namespace } :
      {}
    )
  )
  properties = {
...
resource "octopusdeploy_process_step" "cronjobs_step" {
  ...
  execution_properties = {
    ...
    "Octopus.Action.RunOnServer"               = "true"
    "Octopus.Action.Script.ScriptSource"       = "Inline"
    "Octopus.Action.Script.ScriptBody"         = var.set_cronjob_script_body == "" ? replace(local.set_cronjob_script_body, "__CRONJOB__", each.value.cronjob) : var.set_cronjob_script_body
    "Octopus.Action.Script.Syntax"             = "Bash"
    "Octopus.Action.SubstituteInFiles.Enabled" = "True"
    "OctopusUseBundledTooling"                 = "False"
  }
