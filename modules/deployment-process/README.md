...
| <a name="input_global_steps"></a> [global\_steps](#input\_global\_steps) | n/a | <pre>map(object({<br>    pre_main_global_steps = optional(map(object({<br>      name                 = string<br>      type                 = optional(string, "Octopus.KubernetesRunScript")<br>      is_required          = optional(bool, true)<br>      start_trigger        = optional(string, "StartAfterPrevious")<br>      properties           = map(string)<br>      condition            = optional(string, "Success")<br>      condition_expression = optional(string, "")<br>    })), {})<br>    post_main_global_steps = optional(map(object({<br>      name                 = string<br>      type                 = optional(string, "Octopus.KubernetesRunScript")<br>      is_required          = optional(bool, true)<br>      start_trigger        = optional(string, "StartAfterPrevious")<br>      properties           = map(string)<br>      condition            = optional(string, "Success")<br>      condition_expression = optional(string, "")<br>    })), {})<br>  }))</pre> | `{}` | no |
