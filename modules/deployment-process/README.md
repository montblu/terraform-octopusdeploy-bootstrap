...
| [octopusdeploy_process_step.post_main_global_step](https://registry.terraform.io/providers/OctopusDeploy/octopusdeploy/latest/docs/resources/process_step) | resource |
...
| [octopusdeploy_process_step.pre_main_global_step](https://registry.terraform.io/providers/OctopusDeploy/octopusdeploy/latest/docs/resources/process_step) | resource |
...
| <a name="input_octopus_worker_tools_version"></a> [octopus\_worker\_tools\_version](#input\_octopus\_worker\_tools\_version) | Octopus worker tools version | `string` | `"0.1.0"` | no |
| <a name="input_post_main_global_steps"></a> [post\_main\_global\_steps](#input\_post\_main\_global\_steps) | n/a | <pre>map(object({<br>    name                 = string<br>    type                 = optional(string, "Octopus.KubernetesRunScript")<br>    is_required          = optional(bool, true)<br>    start_trigger        = optional(string, "StartAfterPrevious")<br>    properties           = map(string)<br>    condition            = optional(string, "Success")<br>    condition_expression = optional(string, "")<br>  }))</pre> | `{}` | no |
| <a name="input_pre_main_global_steps"></a> [pre\_main\_global\_steps](#input\_pre\_main\_global\_steps) | n/a | <pre>map(object({<br>    name                 = string<br>    type                 = optional(string, "Octopus.KubernetesRunScript")<br>    is_required          = optional(bool, true)<br>    start_trigger        = optional(string, "StartAfterPrevious")<br>    properties           = map(string)<br>    condition            = optional(string, "Success")<br>    condition_expression = optional(string, "")<br>  }))</pre> | `{}` | no |
| <a name="input_projects"></a> [projects](#input\_projects) | Projects list | <pre>map(object({<br>    create_main_step    = optional(bool, true)<br>    main_step_namespace = optional(string, null)<br>    cronjobs            = optional(list(string), [])<br>    deployment_name     = optional(string, "")<br>    pre_main_optional_steps = optional(map(object({<br>      name                 = string<br>      type                 = optional(string, "Octopus.KubernetesRunScript")<br>      is_required          = optional(bool, true)<br>      start_trigger        = optional(string, "StartAfterPrevious")<br>      properties           = map(string)<br>      condition            = optional(string, "Success")<br>      condition_expression = optional(string, "")<br>    })), {})<br>    post_main_optional_steps = optional(map(object({<br>      name                 = string<br>      type                 = optional(string, "Octopus.KubernetesRunScript")<br>      is_required          = optional(bool, true)<br>      start_trigger        = optional(string, "StartAfterPrevious")<br>      properties           = map(string)<br>      condition            = optional(string, "Success")<br>      condition_expression = optional(string, "")<br>    })), {})<br>  }))</pre> | n/a | yes |
| <a name="input_registry_sufix"></a> [registry\_sufix](#input\_registry\_sufix) | n/a | `string` | `""` | no |
| <a name="input_set_cronjob_script_body"></a> [set\_cronjob\_script\_body](#input\_set\_cronjob\_script\_body) | n/a | `string` | `""` | no |
| <a name="input_set_image_script_body"></a> [set\_image\_script\_body](#input\_set\_image\_script\_body) | n/a | `string` | `""` | no |
