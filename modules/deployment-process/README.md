...
| <a name="input_optional_steps"></a> [optional\_steps](#input\_optional\_steps) | n/a | <pre>map(object({<br>    name                 = string<br>    type                 = optional(string, "Octopus.KubernetesRunScript")<br>    start_trigger        = optional(string, "StartAfterPrevious")<br>    properties           = map(string)<br>    condition            = optional(string, "Success")<br>    condition_expression = optional(string, "")<br>  }))</pre> | `{}` | no |
