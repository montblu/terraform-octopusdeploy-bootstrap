...
| <a name="input_optional_steps"></a> [optional\_steps](#input\_optional\_steps) | n/a | <pre>map(object({<br>    name        = string<br>    properties  = map(string)<br>    condition_expression = optional(string, "")<br>    }))</pre> | `{}` | no |
